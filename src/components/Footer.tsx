...
const Footer = () => {
  ...
  <div className="container mx-auto py-10 px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <p className="mt-4 text-gray-700">400 University Drive Suite 200 Coral Gables, FL 33134 USA</p>
    </div>
     {/* Links */}
    <div>
    ...
    <div>
      ...
      <ul className="mt-4 space-y-2 text-gray-700">
        <li><a href="#" className="hover:text-gray-500">Payment Options</a></li>
        <li><a href="#" className="hover:text-gray-500">Returns</a></li>
        <li><a href="#" className="hover:text-gray-500">Privacy Policies</a></li>
      </ul>
    </div>
    {/* Newsletter */}
    <div>
